...
class DataikanController extends Controller
{
    ...
    {
        return view('dataikan.v_dataikan');
    }

     public function read()
    {
        $data = DataikanModel::all();
    ...
    public function store(Request $request)
    {
        ...
        $dataikan['jenis_ikan'] = $request->jenis_ikan;
        $dataikan['harga_ikan'] = $request->harga_ikan;
        $dataikan['stock_ikan'] = $request->stock_ikan;
        DataikanModel::insert($dataikan);
    }
